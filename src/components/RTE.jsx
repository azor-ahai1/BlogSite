    ...
    return(
        <div className="w-full">
            ...
            <Controller name={name || "content"} control={control} render={
                    ({ field:{onChange}}) => (
                        // {}
                        <Editor apiKey="fpf9l429q8pmk6tepwrofgy9j4nhkfdccesyzbqh8l4boawh" initialValue={defaultValue} init={
                            {initialValue: defaultValue, height: 500, menubar: true, 
                                ...
                                toolbar: "undo redo | blocks | image | bold italic forecolor | align | bullist numlist | oudent indent |removeformat | help",
